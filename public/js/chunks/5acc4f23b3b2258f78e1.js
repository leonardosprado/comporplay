...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    formatEpisodeDate: function formatEpisodeDate(date) {
      return !(function webpackMissingModule() { var e = new Error("Cannot find module 'moment'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(date).fromNow().match(/year/) ? !(function webpackMissingModule() { var e = new Error("Cannot find module 'moment'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(date).format("MMM YYYY") : !(function webpackMissingModule() { var e = new Error("Cannot find module 'moment'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(date).format("DD MMM");
    },
