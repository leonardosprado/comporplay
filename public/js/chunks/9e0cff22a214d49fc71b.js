      ...
      if (this.password1 !== this.password2) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/register-artistpf", {
          ...
          if (e.response.data.errors) {
            console.log("Entrou aqui"); // this.error = Object.values(
            //     e.response.data.errors
            // )[0];
            ...
            console.log("Entrou ali"); // this.error = e.response.data;
  ...
  return !_vm.loadingPage
    ? _c("authentification-template", [
        _c(
          ...
          [
            _c("div", { staticClass: "auth-box__title" }, [
              _c("h2", [_vm._v(_vm._s(_vm.$t("Faça login na sua conta")))]),
            ]),
            _vm._v(" "),
            _c(
              "div",
                  ...
                  _c("div", { staticClass: "link-text flex-grow-1" }, [
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                        " +
                            _vm._s(_vm.$t("Esqueceu sua senha?")) +
                            "\n                    "
                        ),
                      ]
                    ),
