  ...
  methods: {
    register: function register() {
      ...
      if (this.password1 !== this.password2) {
        ...
        axios.post("/api/register-artistpj", {
          name: this.firstname + " " + this.lastname,
          email: this.email,
          password: this.password1,
          type_user: "pj",
