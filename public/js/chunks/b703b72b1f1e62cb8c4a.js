...
/* harmony import */ var _data_estadocivil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../data/estadocivil */ "./resources/js/data/estadocivil.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      EstadoCivil: _data_estadocivil__WEBPACK_IMPORTED_MODULE_3__["default"],
      email: "",
      firstname: "",
      lastname: "",
  ...
  methods: {
    register: function register() {
      ...
      if (this.password1 !== this.password2) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/register-artistpf", {
          ...
          console.log(res);
          _this.success = res.data.message || _this.$t("Account created successfully. You can login now.");

          _this.$notify({
            type: "sucess",
            group: "foo",
            message: res.data.message || _this.$t("Account created successfully. You can login now.")
          });
        })["catch"](function (e) {
          console.log(e);
    ...
    cepCorreios: function cepCorreios() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/address/".concat(this.cep)).then(function (res) {
        console.log(res);
        _this2.bairro = res.data.bairro;
        _this2.cidade = res.data.localidade;
        _this2.endereco = res.data.logradouro;
        _this2.estado = res.data.uf;
      })["catch"](function (e) {
        console.log(e);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return {
      coutries: _data_coutries__WEBPACK_IMPORTED_MODULE_1__["default"],
      email: "",
      razaosocial: "",
      nome_fantasia: "",
      cnpj: "",
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c(
                          ...
                          [
                            _c("v-text-field", {
                              attrs: { label: _vm.$t("Celular"), outlined: "" },
                              model: {
                                value: _vm.celular,
                                callback: function ($$v) {
                                  _vm.celular = $$v
...
/***/ "./resources/js/data/estadocivil.js":
/*!******************************************!*\
  !*** ./resources/js/data/estadocivil.js ***!
  \******************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ([{
  "tipoEstadoCivilCod": 1,
  "nome": "Solteiro"
}, {
  "tipoEstadoCivilCod": 2,
  "nome": "Casado"
}, {
  "tipoEstadoCivilCod": 3,
  "nome": "Viúvo"
}, {
  "tipoEstadoCivilCod": 4,
  "nome": "Separado judicialmente"
}, {
  "tipoEstadoCivilCod": 5,
  "nome": "Divorciado"
}, {
  "tipoEstadoCivilCod": 6,
  "nome": "União estável"
}, {
  "tipoEstadoCivilCod": 7,
  "nome": "Outros"
}]);
