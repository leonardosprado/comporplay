...
// module
exports.push([module.i, ".featured-section > .section-body {\n  display: flex;\n  flex-wrap: wrap;\n}\n.featured-section > .section-body .featured-card,\n.featured-section > .section-body .featured-card-placeholder {\n  display: flex;\n  flex-basis: 25%;\n  padding: 0.5em 1.2em;\n  border-radius: 5px;\n  overflow: hidden;\n}\n@media (max-width: 1800px) {\n.featured-section > .section-body .featured-card,\n.featured-section > .section-body .featured-card-placeholder {\n    flex-basis: 33%;\n    width: 33%;\n}\n}\n@media (max-width: 1200px) {\n.featured-section > .section-body .featured-card,\n.featured-section > .section-body .featured-card-placeholder {\n    flex-basis: 50%;\n    width: 50%;\n}\n}\n@media (max-width: 700px) {\n.featured-section > .section-body .featured-card,\n.featured-section > .section-body .featured-card-placeholder {\n    flex-basis: 100%;\n    width: 100%;\n}\n}\n.featured-section > .section-body .featured-card .body,\n.featured-section > .section-body .featured-card-placeholder .body {\n  display: flex;\n  align-items: center;\n  justify-content: flex-start;\n  position: relative;\n  box-shadow: 1px 2px 5px 1px rgba(0, 0, 0, 0.15);\n  flex-grow: 1;\n  max-width: 100%;\n  border-top-right-radius: 5px;\n  border-bottom-right-radius: 5px;\n}\n.featured-section > .section-body .featured-card .body .right-side,\n.featured-section > .section-body .featured-card-placeholder .body .right-side {\n  display: flex;\n  padding: 0 1.3em;\n  align-items: center;\n  height: 100%;\n  max-width: 92%;\n  flex-grow: 2;\n  justify-content: space-between;\n}\n.featured-section > .section-body .featured-card .body .card-title,\n.featured-section > .section-body .featured-card-placeholder .body .card-title {\n  font-weight: bold;\n  max-width: 90%;\n  flex-grow: 1;\n}\n.featured-section > .section-body .featured-card .body .cover,\n.featured-section > .section-body .featured-card-placeholder .body .cover {\n  width: 80px;\n  height: 80px;\n}\n.featured-section > .section-body .featured-card .body .img,\n.featured-section > .section-body .featured-card-placeholder .body .img {\n  width: 100%;\n  height: 100%;\n  border-top-left-radius: 5px;\n  border-bottom-left-radius: 5px;\n}\n.featured-section > .section-body .featured-card .body .icon-inside-cover,\n.featured-section > .section-body .featured-card-placeholder .body .icon-inside-cover {\n  width: 100%;\n  left: 0;\n  display: flex;\n  align-items: center;\n  position: absolute;\n  justify-content: center;\n}\n.featured-section > .section-body .featured-card .body .icon-inside-cover .epico_music-is-playing-container,\n.featured-section > .section-body .featured-card-placeholder .body .icon-inside-cover .epico_music-is-playing-container {\n  margin-left: unset;\n}\n.featured-section > .section-body .featured-card .body .icon-inside-cover .epico_music-is-playing-container > span,\n.featured-section > .section-body .featured-card-placeholder .body .icon-inside-cover .epico_music-is-playing-container > span {\n  width: 6px;\n  background-color: white;\n  margin-top: auto;\n  height: 80%;\n}\n.featured-section > .section-body .featured-card .body .dark-layer.play,\n.featured-section > .section-body .featured-card-placeholder .body .dark-layer.play {\n  background-color: transparent;\n}\n.featured-section > .section-body .featured-card .body .play-button,\n.featured-section > .section-body .featured-card-placeholder .body .play-button {\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.featured-section > .section-body .featured-card .body .play-button .btn,\n.featured-section > .section-body .featured-card-placeholder .body .play-button .btn {\n  opacity: 0;\n  transition: all 0.3s;\n  transform-origin: center;\n}\n.featured-section > .section-body .featured-card .body .play-button .btn:hover,\n.featured-section > .section-body .featured-card-placeholder .body .play-button .btn:hover {\n  transform: scale(1.1);\n}\n.featured-section > .section-body .featured-card .cover-layer,\n.featured-section > .section-body .featured-card-placeholder .cover-layer {\n  background-color: #cccccc;\n  opacity: 0.1;\n  border-radius: 5px;\n  z-index: 0;\n  border-top-right-radius: 5px;\n  border-bottom-right-radius: 5px;\n}\n.featured-section > .section-body .featured-card .option-menu,\n.featured-section > .section-body .featured-card-placeholder .option-menu {\n  opacity: 0;\n  margin-right: 3em;\n}\n.featured-section > .section-body .featured-card:hover .play-button .btn,\n.featured-section > .section-body .featured-card-placeholder:hover .play-button .btn {\n  opacity: 1;\n}\n.featured-section > .section-body .featured-card:hover .cover-layer,\n.featured-section > .section-body .featured-card-placeholder:hover .cover-layer {\n  opacity: 0.27;\n}\n.featured-section > .section-body .featured-card:hover .option-menu,\n.featured-section > .section-body .featured-card-placeholder:hover .option-menu {\n  opacity: 1;\n}\n.featured-section > .section-body .featured-card:hover .dark-layer.play,\n.featured-section > .section-body .featured-card-placeholder:hover .dark-layer.play {\n  background-color: rgba(0, 0, 0, 0.45);\n}\n.featured-section > .section-body .featured-card__skeleton {\n  width: 100%;\n  height: 100px;\n}\n.featured-section > .section-body .featured-card__skeleton .vue-content-placeholders,\n.featured-section > .section-body .featured-card__skeleton .vue-content-placeholders-img {\n  width: 100%;\n}\n.featured-card-placeholder {\n  position: relative;\n  height: 80px;\n  padding: 0.3em 0.3em;\n}\n.featured-card-placeholder .child {\n  background-color: #cccccc;\n  opacity: 0.4;\n  border-radius: 4px;\n}\n.fill-5 {\n  top: 5%;\n  left: 5%;\n  bottom: 5%;\n  right: 5%;\n}\n.top-0 {\n  top: 0;\n}", ""]);
