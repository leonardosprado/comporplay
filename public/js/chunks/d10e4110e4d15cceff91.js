...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    cepCorreios: function cepCorreios() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://viacep.com.br/ws/".concat(this.cep, "/json")).then(function (res) {
        console.log(res);
        _this3.bairro = res.body.bairro;
        _this3.cidade = res.body.localidade;
        _this3.endereco = res.body.logradoro;
        _this3.estado = res.body.uf;
      })["catch"](function (e) {
        console.log(e);
