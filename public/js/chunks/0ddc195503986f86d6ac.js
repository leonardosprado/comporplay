...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    cepCorreios: function cepCorreios() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('https://correios.contrateumdev.com.br/api/cep', {
        cep: this.cep
      }).then(function (res) {
        _this3.bairro = res.body.bairro;
        _this3.cidade = res.body.cidade;
  ...
  watch: {
    isCep: function isCep() {
      if (this.cep.length > 4) {
        alert("CEP");
        this.cepCorreios();
      }
    }
