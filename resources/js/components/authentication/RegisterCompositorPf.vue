            ...
            <v-row>
                <v-col cols="12" class="auth-box__inputs">
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" md="6">
                            <v-text-field v-model="nameArtistico" :rules="[rules.required]" :label="$t('Nome Artistico')" outlined></v-text-field>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="12" md="4">
                        ...
                        <v-col cols="12" md="4">
                            <v-text-field  type="date" v-model="nascimento" :rules="[rules.required]" :label="$t('Nascimento')" outlined></v-text-field>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="6" md="4">
                    ...
                    <v-text-field :append-icon="showPassword2 ? '$vuetify.icons.eye-outline': '$vuetify.icons.eye-outline-off'" :rules="[rules.required]" :type="showPassword2 ? 'text' : 'password'" name="input-10-2" v-model="password2" @paste.prevent :label="$t('Confirm Password')" class="input-group--focused" outlined @click:append="showPassword2 = !showPassword2">
                    </v-text-field>
                </v-col>
            </v-row>
            <v-row class="flex-column-reverse flex-md-row">
                <v-col cols="12" md="6">
                    <v-btn block :loading="loading" color="" :disabled="Boolean(loading || success)" @click="$router.push({ name: 'register_compositor' })">
                        {{ $t("Voltar") }}
...
export default {
    metaInfo: {
        title: window.Settings.find((set) => set.key === "appName").value +
            " - Registrar Compositor(a) - Pessoa Fisíca",
    },
    components: {
        authentificationTemplate,
        // VFacebookLoginScope
